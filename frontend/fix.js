//C:\quran-similarity-app\frontend\fix.js
const fs = require('fs');
const path = require('path');

const baseDir = process.cwd(); // ensures correct root

const files = {
  './src/shared/components/StreakBanner.jsx': `import React, { useState, useEffect } from "react";
...
export default StreakBanner;`
  // NOTE: keep rest of your files unchanged
};
